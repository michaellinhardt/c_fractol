...
/*   Updated: 2016/12/27 22:58:52 by mlinhard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		keyr_hook(int key, t_data *d)
{
	...
	{
		(key == 123 && loopstop(3)) ? d->mlx.input.left = 0 : 0;
		(key == 124 && loopstop(3)) ? d->mlx.input.right = 0 : 0;
		(key == 125 && loopstop(3)) ? d->mlx.input.down = 0 : 0;
		(key == 126 && loopstop(3)) ? d->mlx.input.up = 0 : 0;
		if (key == 116 && loopstop(3))
			d->mlx.input.wheelup = 0;
		if (key == 121 && loopstop(3))
...
{
	(key == 123 && loopstop(3)) ? d->mlx.input.left = 1 : 0;
	(key == 124 && loopstop(3)) ? d->mlx.input.right = 1 : 0;
	(key == 125 && loopstop(3)) ? d->mlx.input.down = 1 : 0;
	(key == 126 && loopstop(3)) ? d->mlx.input.up = 1 : 0;
	if (key == 116 && loopstop(3))
